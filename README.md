...
Локальный генератор карточек товара (заголовок, краткое описание и пункты) через Ollama. Выход — строгий JSON. Есть CLI и Telegram‑бот‑скелет. Новое в v0.4: профили платформ (Ozon/WB/Etsy/Shopify), выбор стиля и длины, валидация по лимитам платформ.
...
## Документация
- Дорожная карта версий: `docs/ROADMAP.md` (текущий статус: v0.4)
